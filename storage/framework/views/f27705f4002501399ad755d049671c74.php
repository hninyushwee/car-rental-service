<aside id="userSidebar" class="h-screen flex-shrink-0 border-r-2 border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 transition-all duration-300 flex flex-col overflow-hidden">
    ...
    <div id="userSidebarHeader" class="h-16 border-b-2 border-slate-200 dark:border-slate-700 px-4 flex items-center justify-between gap-2 flex-shrink-0">
        <a id="userSidebarBrand" href="<?php echo e(route('dashboard')); ?>" class="flex items-center gap-3 flex-1 min-w-0 overflow-hidden">
            <img id="userSidebarLogo" src="<?php echo e(asset('images/logo.png')); ?>" alt="SkyLine" class="h-8 w-auto shrink-0">
    ...
    <nav class="flex-1 min-h-0 space-y-1 p-4 overflow-y-auto">
        ...
        <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center gap-3 rounded-xl px-4 py-3 text-sm font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition">
        ...
        <a href="<?php echo e(route('rent_car')); ?>" class="flex items-center gap-3 rounded-xl px-4 py-3 text-sm font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition">
            <i data-lucide="car" class="h-5 w-5 flex-shrink-0"></i>
            <span data-sidebar-label>Rent a Car</span>
        </a>
        <a href="<?php echo e(route('rent_driver')); ?>" class="flex items-center gap-3 rounded-xl px-4 py-3 text-sm font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition">
        ...
        <a href="<?php echo e(route('history')); ?>" class="flex items-center gap-3 rounded-xl px-4 py-3 text-sm font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition">
            <i data-lucide="history" class="h-5 w-5 flex-shrink-0"></i>
            <span data-sidebar-label>Booking History</span>
        </a>
        <a href="<?php echo e(route('inquiry')); ?>" class="flex items-center gap-3 rounded-xl px-4 py-3 text-sm font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition">
            <i data-lucide="messages-square" class="h-5 w-5 flex-shrink-0"></i>
            <span data-sidebar-label>General Inquiries</span>
        </a>
        <a href="<?php echo e(route('noti')); ?>" class="flex items-center gap-3 rounded-xl px-4 py-3 text-sm font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition">
...
<?php /**PATH C:\Users\hp\Documents\Portfolio\car-rental-service\resources\views/components/user/sidebar.blade.php ENDPATH**/ ?>