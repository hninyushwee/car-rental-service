            ...
            <div class="relative z-10 w-full max-w-md">
                <div class="text-center mb-5 animate-fade-in">
                    <img class="mx-auto h-10 w-10 object-contain sm:h-14 sm:w-14 md:h-18 md:w-18"
                        src="<?php echo e(asset('images/logo.png')); ?>" alt="SkyLine Automotive logo" />
                    <h1 class="text-2xl text-white mb-1"><?php echo $__env->yieldContent('header'); ?></h1>
                </div>
                <?php echo e($slot); ?>
...
<?php /**PATH C:\Users\hp\Documents\Portfolio\car-rental-service\resources\views/components/auth/layout.blade.php ENDPATH**/ ?>