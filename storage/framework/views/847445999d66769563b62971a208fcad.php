            ...
            <div class="px-8 pb-8">
                <div class="flex flex-col md:flex-row items-start md:items-end gap-6 -mt-16 mb-8">
                    <div class="flex-shrink-0">
                        <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode(Auth::user()->name)); ?>&size=128&background=06b6d4&color=fff" alt="Profile Avatar" class="w-32 h-32 rounded-xl border-4 border-white shadow-lg">
                    </div>
                    <div class="flex-1">
                        <h1 class="text-3xl font-bold text-slate-900 mb-2"><?php echo e(Auth::user()->name); ?></h1>
                        <div class="flex flex-wrap gap-4 text-slate-600">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <span><?php echo e(Auth::user()->phone ?? 'No phone number'); ?></span>
                            </div>
                        </div>
                    </div>
                ...
                <!-- Stats -->
                <?php $bookingCount = Auth::user()->bookings()->count(); ?>
                <div class="grid grid-cols-3 gap-4">
                    <div class="bg-gradient-to-br from-cyan-50 to-blue-50 rounded-lg p-4 border border-cyan-200">
                        <p class="text-3xl font-bold text-cyan-600 mb-1"><?php echo e($bookingCount); ?></p>
                    ...
                    <div class="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-lg p-4 border border-emerald-200">
                        <p class="text-3xl font-bold text-emerald-600 mb-1"><?php echo e(Auth::user()->created_at->format('M Y')); ?></p>
                    ...
                    <div class="bg-gradient-to-br from-amber-50 to-orange-50 rounded-lg p-4 border border-amber-200">
                        <p class="text-3xl font-bold text-amber-600 mb-1"><?php echo e($bookingCount > 0 ? 'Active' : 'New'); ?></p>
                    ...
                    <form class="space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" value="<?php echo e(Auth::user()->name); ?>" class="w-full px-4 py-3 rounded-lg border-2 border-slate-200 focus:border-cyan-500 focus:ring-2 focus:ring-cyan-200 transition-all duration-300 text-slate-900">
                            </div>

                            <!-- Email -->
                            <div>
                                <label class="block text-sm font-semibold text-slate-900 mb-2">Email Address</label>
                                <input type="email" value="<?php echo e(Auth::user()->email); ?>" class="w-full px-4 py-3 rounded-lg border-2 border-slate-200 focus:border-cyan-500 focus:ring-2 focus:ring-cyan-200 transition-all duration-300 text-slate-900">
                            </div>

                            <!-- Phone -->
                            <div>
                                <label class="block text-sm font-semibold text-slate-900 mb-2">Phone Number</label>
                                <input type="tel" value="<?php echo e(Auth::user()->phone ?? ''); ?>" class="w-full px-4 py-3 rounded-lg border-2 border-slate-200 focus:border-cyan-500 focus:ring-2 focus:ring-cyan-200 transition-all duration-300 text-slate-900">
                            </div>
                        </div>
...
<?php endif; ?><?php /**PATH C:\Users\hp\Documents\Portfolio\car-rental-service\resources\views/user/profile.blade.php ENDPATH**/ ?>