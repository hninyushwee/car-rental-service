...
<?php $component->withAttributes([]); ?>
    <div data-page="admin-analytics-customers" data-api-url="<?php echo e(url('/api/admin/analytics/customers')); ?>" data-login-url="<?php echo e(route('login')); ?>" data-admin-url="<?php echo e($adminUrl); ?>" class="p-4 sm:p-6 md:p-8">
...
<?php endif; ?>
<?php /**PATH C:\Users\hp\Documents\Portfolio\car-rental-service\resources\views/admin/analytics/customers.blade.php ENDPATH**/ ?>