...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Deposit Settings']); ?>
<div data-page="admin-deposit-settings" data-api-base="/api/admin/deposit-settings" data-is-super-admin="<?php echo e(auth()->user()->hasRole('super-admin') ? 'true' : 'false'); ?>" class="p-4 sm:p-6 md:p-8">
  <div class="mb-5 rounded-xl border border-cyan-500/20 bg-gradient-to-br from-cyan-500/10 via-cyan-400/5 to-cyan-600/10 px-3 py-2 backdrop-blur-sm dark:border-cyan-500/10 sm:px-4 sm:py-2.5">
    <div class="flex flex-wrap items-center justify-between gap-3">
      ...
      <a href="<?php echo e(route('admin.deposit-settings.create')); ?>" class="inline-flex items-center gap-2 rounded-lg bg-cyan-400 px-5 py-2.5 text-sm font-semibold text-black shadow-sm transition-all hover:bg-cyan-500">
...
<script src="<?php echo e(mix('js/admin/deposits/deposit-page.js')); ?>"></script>
<?php $__env->stopPush(); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\hp\Documents\Portfolio\car-rental-service\resources\views/admin/deposit_settings/index.blade.php ENDPATH**/ ?>