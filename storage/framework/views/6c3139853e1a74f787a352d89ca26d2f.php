...
<?php $component->withAttributes([]); ?>
    <div id="vehicleDetailsContainer" data-page="admin-vehicle-show" data-id="<?php echo e($vehicleId); ?>"
        data-api-base="<?php echo e(url('/api/admin/vehicles')); ?>" data-login-url="<?php echo e(route('login')); ?>" data-admin-url="<?php echo e($adminUrl); ?>" class="p-4 sm:p-6 md:p-8">
        ...
        <div id="detailsContent" class="hidden">
            <div class="mb-8">
                <a href="<?php echo e($adminUrl); ?>/vehicles" class="mb-4 inline-flex items-center gap-2 rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm font-medium text-slate-700 transition hover:bg-slate-50 dark:border-slate-600 dark:bg-slate-800 dark:text-slate-300 dark:hover:bg-slate-700">
...
<?php endif; ?>
<?php /**PATH C:\Users\hp\Documents\Portfolio\car-rental-service\resources\views/admin/vehicles/show.blade.php ENDPATH**/ ?>