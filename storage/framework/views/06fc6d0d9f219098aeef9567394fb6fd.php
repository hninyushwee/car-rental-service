...
<?php $component->withAttributes([]); ?>
    <div data-page="admin-promotions" data-api-base="<?php echo e(url('/api/admin/promotions')); ?>" data-is-super-admin="<?php echo e(auth()->user()->hasRole('super-admin') ? 'true' : 'false'); ?>" class="p-4 sm:p-6 md:p-8">
        ...
        <div class="mb-5 rounded-xl border border-cyan-500/20 bg-gradient-to-br from-cyan-500/10 via-cyan-400/5 to-cyan-600/10 px-3 py-2 backdrop-blur-sm dark:border-cyan-500/10 sm:px-4 sm:py-2.5">
            <div class="flex flex-wrap items-center justify-between gap-3">
                ...
                <a href="<?php echo e(url('/admin/promotions/add')); ?>" class="group flex items-center gap-2 rounded-lg bg-cyan-400 px-5 py-2.5 text-sm font-medium text-black shadow-sm transition-all hover:bg-cyan-500">
...
<?php endif; ?>
<?php /**PATH C:\Users\hp\Documents\Portfolio\car-rental-service\resources\views/admin/promotions/index.blade.php ENDPATH**/ ?>