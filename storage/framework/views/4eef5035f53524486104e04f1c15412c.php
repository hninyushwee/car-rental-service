...
<?php $component->withAttributes([]); ?>
    <div data-page="admin-brands" data-api-base="<?php echo e(url('/api/admin/brands')); ?>" data-login-url="<?php echo e(route('login')); ?>" class="p-4 sm:p-6 md:p-8">
        <div class="mb-5 rounded-xl border border-cyan-500/20 bg-gradient-to-br from-cyan-500/10 via-cyan-400/5 to-cyan-600/10 px-3 py-2 backdrop-blur-sm dark:border-cyan-500/10 sm:px-4 sm:py-2.5">
            <div class="flex flex-wrap items-center justify-between gap-3">
                <div>
                    <h1 class="bg-gradient-to-r from-cyan-600 to-blue-600 bg-clip-text text-base font-bold text-transparent dark:from-cyan-400 dark:to-blue-400 sm:text-lg"> Vehicle Brands
                    </h1>
            ...
            <section class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-700 dark:bg-slate-800">
                <div class="mb-5 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div class="relative w-full sm:w-64">
                        ...
                        <input type="text" id="tableSearchInput" placeholder="Search brands..." class="h-9 w-full rounded-xl border border-slate-300 bg-white pl-9 pr-4 text-xs font-medium text-slate-800 shadow-sm transition focus:border-cyan-500 focus:outline-none focus:ring-4 focus:ring-cyan-500/20 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100">
                    </div>
                </div>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full border-collapse text-left">
                        ...
                        <tbody id="brandsTableBody" class="divide-y divide-slate-100 text-sm text-slate-700 dark:divide-slate-700/50 dark:text-slate-300">
                            <tr>
                                <td colspan="3" class="py-6 text-center text-slate-400">Loading brands...</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <aside class="lg:sticky lg:top-20 lg:self-start">
                <section class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-700 dark:bg-slate-800">
                    <div class="mb-4 flex items-center gap-3">
                        ...
                        <div>
                            <h3 id="formTitle" class="text-base font-bold text-slate-900 dark:text-white">New Brand</h3>
                    ...
                    <form id="brandForm" class="space-y-4">
                        ...
                        <div>
                            <label for="brand_name" class="mb-1.5 block text-xs font-semibold text-slate-600 dark:text-slate-400">Brand Name</label>
                            <input type="text" id="brand_name" placeholder="Example: Toyota, BYD, Honda" required class="h-11 w-full rounded-xl border border-slate-300 bg-white px-4 text-sm font-medium text-slate-800 shadow-sm transition focus:border-cyan-500 focus:outline-none focus:ring-4 focus:ring-cyan-500/20 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100">
                        </div>
    ...
    <div id="deleteConfirmationModal" class="fixed inset-0 z-50 hidden items-center justify-center p-4">
        ...
        <div class="relative w-full max-w-md transform overflow-hidden rounded-2xl border border-slate-200 bg-white p-6 shadow-2xl transition-all dark:border-slate-700 dark:bg-slate-800">
            <div class="flex flex-col items-center text-center">
                ...
                <h3 class="text-lg font-bold text-slate-900 dark:text-white">Delete Brand?</h3>
...
<?php endif; ?>
<?php /**PATH C:\Users\hp\Documents\Portfolio\car-rental-service\resources\views/admin/brands/index.blade.php ENDPATH**/ ?>