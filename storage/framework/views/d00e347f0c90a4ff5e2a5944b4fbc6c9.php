...
<?php $component->withAttributes([]); ?>
    <div id="formLayoutWrapper" data-page="admin-driver-form" data-edit="<?php echo e($isEdit ? 'true' : 'false'); ?>" data-id="<?php echo e($driverId ?? ''); ?>" data-drivers-api="<?php echo e(url('/api/admin/drivers')); ?>" data-vehicles-api="<?php echo e(url('/api/admin/vehicles')); ?>" data-index-url="<?php echo e(route('admin.drivers.index')); ?>" data-login-url="<?php echo e(route('login')); ?>" class="p-4 sm:p-6 md:p-8">
        <!-- Page Header -->
            ...
            <div class="flex flex-wrap items-center justify-between gap-3">
                <div>
                    <h1 id="formPageHeader" class="bg-gradient-to-r from-cyan-600 to-blue-600 bg-clip-text text-base font-bold text-transparent dark:from-cyan-400 dark:to-blue-400 sm:text-lg">
                        <?php echo e($isEdit ? 'Edit Driver Profile' : 'Add New Driver'); ?>
                    ...
                    <p id="formPageSubheader" class="mt-0.5 flex items-center gap-2 text-slate-600 dark:text-slate-400">
                        ...
                        <span><?php echo e($isEdit ? 'Update this driver profile' : 'Add a driver to your fleet'); ?></span>
                    </p>
                </div>
                <a href="<?php echo e(route('admin.drivers.index')); ?>" class="flex items-center gap-2 rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm font-medium text-slate-700 transition hover:bg-slate-50 dark:border-slate-600 dark:bg-slate-800 dark:text-slate-300 dark:hover:bg-slate-700">
            ...
            <form id="driverForm" class="order-2 lg:order-1 space-y-5" enctype="multipart/form-data">
                ...
                <div class="flex gap-3">
                    <button type="submit" id="submitFormBtn" class="flex-1 rounded-lg bg-cyan-400 px-5 py-2.5 text-center text-sm font-bold text-black transition hover:bg-cyan-500">
                        <?php echo e($isEdit ? 'Update Driver' : 'Create Driver'); ?>
...
<?php endif; ?><?php /**PATH C:\Users\hp\Documents\Portfolio\car-rental-service\resources\views/admin/drivers/create.blade.php ENDPATH**/ ?>