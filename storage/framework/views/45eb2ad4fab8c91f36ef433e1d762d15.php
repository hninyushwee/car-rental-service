...
<head>
    ...
    <title>Invoice #<?php echo e($booking->booking_number); ?></title>
    <style>
...
<body>
    <div class="wrapper">
        <div class="header">
            ...
            <p>Invoice #<?php echo e($booking->booking_number); ?></p>
        </div>
        <div class="body">
            <div class="section">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value">#<?php echo e($booking->booking_number); ?></span>
                </div>
                <div class="info-row">
                    <span class="info-label">Status</span>
                    <span class="info-value"><span class="badge badge-confirmed"><?php echo e(ucfirst($booking->status)); ?></span></span>
                </div>
                <div class="info-row">
                    <span class="info-label">Date</span>
                    <span class="info-value"><?php echo e($booking->created_at->format('M d, Y')); ?></span>
                </div>
            </div>
            ...
            <div class="section">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value"><?php echo e($booking->user->name); ?></span>
                </div>
                <div class="info-row">
                    <span class="info-label">Email</span>
                    <span class="info-value"><?php echo e($booking->user->email); ?></span>
                </div>
                <?php if($booking->user->phone): ?>
                <div class="info-row">
                    <span class="info-label">Phone</span>
                    <span class="info-value"><?php echo e($booking->user->phone); ?></span>
                </div>
                <?php endif; ?>
            </div>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo e($item->start_date ? \Carbon\Carbon::parse($item->start_date)->format('M d') : '-'); ?> - <?php echo e($item->end_date ? \Carbon\Carbon::parse($item->end_date)->format('M d') : '-'); ?></td>
                            <td><?php echo e($item->has_driver ? ($item->driver->name ?? 'Auto-assigned') : 'No'); ?></td>
                            <td><?php echo e($item->quantity ?? 1); ?></td>
                            <td>MMK <?php echo e(number_format($itemTotal, 2)); ?></td>
                        </tr>
            ...
            <div class="section">
                <table>
                    <tr class="total-row">
                        ...
                        <td class="value">MMK <?php echo e(number_format($booking->subtotal_price, 2)); ?></td>
                    </tr>
                    <?php if((float) $booking->discount_amount > 0): ?>
                    <tr class="total-row">
                        <td colspan="4" class="label">Discount<?php echo e($booking->promotionUsage?->promotion ? ' (' . $booking->promotionUsage->promotion->code . ')' : ''); ?></td>
                        <td class="value" style="color:#dc2626;">-MMK <?php echo e(number_format($booking->discount_amount, 2)); ?></td>
                    </tr>
                    <?php endif; ?>
                    <tr class="total-row grand-total">
                        <td colspan="4" class="label">Total</td>
                        <td class="value">MMK <?php echo e(number_format($booking->total_price, 2)); ?></td>
                    </tr>
                    ...
                    <tr class="total-row">
                        ...
                        <td class="value" style="color:#059669;">MMK <?php echo e(number_format($totalPaid, 2)); ?></td>
                    </tr>
                    <tr class="total-row">
                        <td colspan="4" class="label" style="color:#dc2626;">Remaining Balance</td>
                        <td class="value" style="color:#dc2626;">MMK <?php echo e(number_format($remaining, 2)); ?></td>
                    </tr>
                </table>
                ...
                <div class="deposit-note">
                    ...
                    <br>Car Rental Deposit: MMK <?php echo e(number_format($booking->car_deposit_snapshot, 2)); ?>

                    <?php endif; ?>
                    <?php if($booking->driver_deposit_snapshot): ?>
                    <br>Driver Service Deposit: MMK <?php echo e(number_format($booking->driver_deposit_snapshot, 2)); ?>
        ...
        <div class="footer">
            &copy; <?php echo e(date('Y')); ?> SkyLine Car Rental. All rights reserved.<br>
            <a href="<?php echo e(config('app.url')); ?>/contact" style="color:#94a3b8;text-decoration:underline;">Unsubscribe</a>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\Users\hp\Documents\Portfolio\car-rental-service\resources\views/emails/booking-invoice.blade.php ENDPATH**/ ?>