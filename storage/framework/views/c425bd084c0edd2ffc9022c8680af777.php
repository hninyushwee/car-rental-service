  ...
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
      ...
      <div class="group rounded-2xl border border-slate-200 bg-white p-6 text-center transition-all duration-500 hover:-translate-y-2 hover:shadow-xl hover:border-cyan-300">
        <img class="mx-auto h-28 w-28 rounded-full object-cover ring-4 ring-cyan-100 transition-all duration-300 group-hover:ring-cyan-300" src="<?php echo e($member['img']); ?>" alt="<?php echo e($member['name']); ?>" />
        <h3 class="mt-4 text-xl font-bold text-slate-900"><?php echo e($member['name']); ?></h3>
        <p class="text-sm text-cyan-600"><?php echo e($member['role']); ?></p>
        <p class="mt-2 text-sm text-slate-500"><?php echo e($member['bio']); ?></p>
      </div>
...
<?php endif; ?><?php /**PATH C:\Users\hp\Documents\Portfolio\car-rental-service\resources\views/user/about.blade.php ENDPATH**/ ?>