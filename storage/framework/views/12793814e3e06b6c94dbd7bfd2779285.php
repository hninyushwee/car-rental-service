<header id="userNavbar" class="fixed top-0 right-0 z-30 h-16 border-b-2 border-slate-200 dark:border-slate-700 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md">
    <nav class="flex items-center justify-between gap-4 px-4 py-3 sm:px-6 md:px-8 w-full">
        ...
        <div class="flex items-center gap-2 sm:gap-3 ml-auto">
            <!-- Cart -->
            <a href="<?php echo e(route('cart.view')); ?>" class="relative flex h-10 w-10 items-center justify-center rounded-lg border-2 border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700 transition">
            ...
            <div class="relative">
                ...
                <div id="userNotificationDropdown" class="absolute right-0 mt-2 hidden w-96 overflow-hidden rounded-2xl border-2 border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 shadow-2xl">
                    <div class="flex items-center justify-between border-b border-slate-200 dark:border-slate-700 px-6 py-4">
                        ...
                        <a href="<?php echo e(route('noti')); ?>" class="text-xs font-medium text-cyan-600 hover:text-cyan-500 dark:text-cyan-400">View all</a>
                    </div>
            ...
            <div class="relative">
                <button id="userProfileBtn" type="button" class="flex items-center gap-2 rounded-lg border-2 border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 p-1 pr-3 text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700 transition">
                    <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode(Auth::user()->name)); ?>&size=64&background=06b6d4&color=fff" alt="User" class="h-8 w-8 rounded object-cover">
                ...
                <div id="userProfileDropdown" class="absolute right-0 mt-2 hidden w-72 overflow-hidden rounded-2xl border-2 border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 shadow-2xl">
                    <div class="flex items-center gap-3 border-b border-slate-200 dark:border-slate-700 px-6 py-4">
                        <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode(Auth::user()->name)); ?>&size=96&background=06b6d4&color=fff" alt="User" class="h-12 w-12 rounded object-cover">
                        <div>
                    ...
                    <div class="p-2">
                        <a href="<?php echo e(route('profile')); ?>" class="flex items-center gap-3 rounded-lg px-4 py-2 text-sm font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700 transition">
                            <i data-lucide="user" class="h-4 w-4"></i>My Profile
                        </a>
                        <a href="<?php echo e(route('profile')); ?>" class="flex items-center gap-3 rounded-lg px-4 py-2 text-sm font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700 transition">
                            <i data-lucide="settings" class="h-4 w-4"></i>Account Settings
                        </a>
                        <a href="<?php echo e(route('history')); ?>" class="flex items-center gap-3 rounded-lg px-4 py-2 text-sm font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700 transition">
...
<?php /**PATH C:\Users\hp\Documents\Portfolio\car-rental-service\resources\views/components/user/auth-navbar.blade.php ENDPATH**/ ?>