...
<?php $component->withAttributes([]); ?>
    <div data-page="admin-staff" data-api-base="<?php echo e(url('/api/admin/staff')); ?>" data-login-url="<?php echo e(route('login')); ?>" class="p-4 sm:p-6 md:p-8">
        <div class="mb-5 rounded-xl border border-cyan-500/20 bg-gradient-to-br from-cyan-500/10 via-cyan-400/5 to-cyan-600/10 px-3 py-2 backdrop-blur-sm dark:border-cyan-500/10 sm:px-4 sm:py-2.5">
            <div class="flex flex-wrap items-center justify-between gap-3">
                <div>
                    <h1 class="bg-gradient-to-r from-cyan-600 to-blue-600 bg-clip-text text-base font-bold text-transparent dark:from-cyan-400 dark:to-blue-400 sm:text-lg">Staff</h1>
                    <p class="mt-0.5 flex items-center gap-2 text-slate-600 dark:text-slate-400">
                        <i data-lucide="users" class="h-3 w-3"></i>
                        Manage staff accounts
                    </p>
                </div>
                <a href="<?php echo e(route('admin.staff.create')); ?>" class="flex items-center gap-2 rounded-lg bg-cyan-400 px-3 py-2 text-sm font-bold text-black transition hover:bg-cyan-500">
        ...
        <div class="mb-6 grid grid-cols-1 gap-4 sm:grid-cols-3">
            <div class="rounded-xl border border-slate-200/60 bg-white/90 p-3 shadow-sm dark:border-slate-700/60 dark:bg-slate-800/90">
                <div class="flex items-center gap-2">
                    ...
                    <div>
                        <p class="text-[10px] text-slate-500 dark:text-slate-400">Total Staff</p>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm">
                    ...
                    <tbody id="staffTableBody">
                        <tr>
                            <td colspan="6" class="px-4 py-12 text-center text-slate-400">Loading staff data...</td>
                        </tr>
                    </tbody>
                </table>
            </div>
    ...
    <div id="deleteConfirmationModal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/50 backdrop-blur-sm">
        <div class="w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl dark:bg-slate-800">
            <div class="mb-4 flex items-center gap-3">
                ...
                <h3 class="text-lg font-bold text-slate-900 dark:text-white">Delete Staff</h3>
            </div>
            <p class="mb-6 text-sm text-slate-600 dark:text-slate-400">Are you sure you want to delete this staff member? This action cannot be undone.</p>
...
<?php endif; ?>
<?php /**PATH C:\Users\hp\Documents\Portfolio\car-rental-service\resources\views/admin/staff/index.blade.php ENDPATH**/ ?>