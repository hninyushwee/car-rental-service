...
<div data-page="cart-view" data-api-base="{{ url('/') }}" class="pt-8 pb-16 bg-gradient-to-br from-slate-50/80 via-white to-slate-50/60 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 min-h-screen fade-up">
  <div class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
    ...
    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
      ...
      <a href="{{ route('rent_car') }}" onclick="history.back(); return false;" class="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-white/70 dark:bg-slate-800/70 backdrop-blur-sm text-sm font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700/70 hover:border-slate-300 dark:hover:border-slate-600 transition-all duration-200 hover:shadow-md">
    ...
    <div class="mt-8 grid gap-8 lg:grid-cols-5">
              ...
              <div class="grid grid-cols-3 gap-3">
                <label class="cursor-pointer">
                  ...
                  <div class="gateway-card rounded-xl p-3.5 flex flex-col items-center justify-center gap-2 peer-checked:selected">
                    <img src="{{ asset('images/kbz-logo.webp') }}" alt="KBZPay" class="h-8 w-auto object-contain">
                ...
                <label class="cursor-pointer">
                  ...
                  <div class="gateway-card rounded-xl p-3.5 flex flex-col items-center justify-center gap-2 peer-checked:selected">
                    <img src="{{ asset('images/wave.jpg') }}" alt="WavePay" class="h-8 w-auto object-contain">
                ...
                <label class="cursor-pointer">
                  ...
                  <div class="gateway-card rounded-xl p-3.5 flex flex-col items-center justify-center gap-2 peer-checked:selected">
                    <img src="{{ asset('images/kbz.png') }}" alt="Bank Transfer" class="h-8 w-auto object-contain">
            ...
            <div class="mt-4 p-4 panel-card rounded-xl transition-all">
              <div id="panel-kpay" class="payment-panel space-y-4">
                ...
                <div class="qr-wrapper flex flex-col items-center justify-center">
                  <img src="{{ asset('images/qr_code.png') }}" alt="KBZPay QR" class="w-20 h-20 object-contain">
              ...
              <div id="panel-wavepay" class="payment-panel hidden space-y-4">
                ...
                <div class="qr-wrapper flex flex-col items-center justify-center">
                  <img src="{{ asset('images/qr_code.png') }}" alt="WavePay QR" class="w-20 h-20 object-contain">
              ...
              <div id="panel-bank_transfer" class="payment-panel hidden space-y-4">
                ...
                <div class="rounded-xl border border-slate-200 dark:border-slate-700 bg-gradient-to-br from-slate-800 to-slate-950 p-4 text-white font-mono shadow-lg">
                  <div class="flex justify-between items-center text-xs text-slate-400 font-sans">
                    <span>Gateway</span>
                    <img src="{{ asset('images/kbz.png') }}" alt="KBZ" class="h-6 w-auto object-contain brightness-200">
                  </div>
      ...
      <div id="cartEmpty" class="hidden lg:col-span-5">
        <div class="summary-card rounded-3xl p-16 text-center">
          ...
          <a href="{{ route('rent_car') }}" class="inline-flex items-center gap-2 mt-6 px-6 py-3 bg-cyan-400 dark:bg-cyan-500 text-black dark:text-white font-bold rounded-xl hover:bg-cyan-500 dark:hover:bg-cyan-400 transition-all hover:shadow-lg hover:-translate-y-0.5">
