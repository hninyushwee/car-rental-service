...
<div data-page="rent-car-form" data-api-base="{{ url('/') }}" data-vehicle-id="{{ request('vehicle_id') }}" class="pt-8 pb-16 bg-slate-50/50 dark:bg-slate-950 min-h-screen fade-up">
  <div class="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
    <div class="flex items-center justify-between">
      ...
      <a href="{{ route('rent_car') }}" class="flex items-center gap-2 rounded-lg border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 px-3 py-2 text-sm font-medium text-slate-700 dark:text-slate-300 transition hover:bg-slate-50 dark:hover:bg-slate-700">
