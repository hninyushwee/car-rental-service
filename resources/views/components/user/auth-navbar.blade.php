<header id="userNavbar" class="fixed top-0 right-0 z-30 h-16 border-b-2 border-slate-200 dark:border-slate-700 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md">
    <nav role="navigation" aria-label="Account navigation" class="flex items-center justify-between gap-4 px-4 py-3 sm:px-6 md:px-8 w-full">
        ...
        <div class="flex items-center gap-2 sm:gap-3 ml-auto">
            <!-- Cart -->
            <a href="{{ route('cart.view') }}" class="relative flex h-10 w-10 items-center justify-center rounded-lg border-2 border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700 transition" aria-label="View cart">
            ...
            <!-- Notifications -->
            <div class="relative">
                <button id="userNotificationBtn" type="button" class="relative flex h-10 w-10 items-center justify-center rounded-lg border-2 border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700 transition" aria-label="Open notifications" aria-haspopup="menu" aria-expanded="false">
            ...
            <!-- Theme Toggle -->
            <button id="userThemeToggle" type="button" class="flex h-10 w-10 items-center justify-center rounded-lg border-2 border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700 transition" aria-label="Toggle theme">
                <i data-lucide="moon" class="h-5 w-5"></i>
            </button>

            <!-- Profile -->
            <div class="relative">
                <button id="userProfileBtn" type="button" class="flex items-center gap-2 rounded-lg border-2 border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 p-1 pr-3 text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700 transition" aria-label="Open profile menu" aria-haspopup="menu" aria-expanded="false">
                    <img src="https://ui-avatars.com/api/?name={{ urlencode(Auth::user()->name) }}&size=64&background=06b6d4&color=fff" alt="User avatar" class="h-8 w-8 rounded object-cover">
