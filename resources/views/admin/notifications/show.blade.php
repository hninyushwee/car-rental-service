<x-admin.layout>
    <div data-page="admin-notification-show" data-api-base="{{ url('/api/admin/notifications') }}" data-notifications-url="{{ url(auth()->user()->hasRole('super-admin') ? '/admin/notifications' : '/staff/notifications') }}" data-notification-id="{{ $notificationId }}" class="p-4 sm:p-6 md:p-8">
        ...
        <div id="notificationContent" class="hidden"></div>
        <div id="errorState" class="hidden py-20 text-center text-red-500 dark:text-red-400">
            <p id="errorMessage">Failed to load notification.</p>
