    ...
    <div id="formLayoutWrapper" data-page="admin-vehicle-form" data-edit="{{ $isEdit ? 'true' : 'false' }}" data-id="{{ $vehicleId ?? '' }}" data-vehicles-api="{{ url('/api/admin/vehicles') }}" data-brands-api="{{ url('/api/admin/brands') }}" data-categories-api="{{ url('/api/admin/categories') }}" data-index-url="{{ route('admin.vehicles.index') }}" data-login-url="{{ route('login') }}" class="p-4 sm:p-6 md:p-8">
        <div class="mb-5 rounded-xl border border-cyan-500/20 bg-gradient-to-br from-cyan-500/10 via-cyan-400/5 to-cyan-600/10 px-3 py-2 backdrop-blur-sm dark:border-cyan-500/10 sm:px-4 sm:py-2.5">
            <div class="flex flex-wrap items-center justify-between gap-3">
                <div>
                    <h1 id="formPageHeader" class="bg-gradient-to-r from-cyan-600 to-blue-600 bg-clip-text text-base font-bold text-transparent dark:from-cyan-400 dark:to-blue-400 sm:text-lg">{{ $isEdit ? 'Edit Vehicle Profile' : 'Add New Vehicle' }}
                    </h1>
