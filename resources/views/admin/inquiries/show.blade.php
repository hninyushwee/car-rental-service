<x-admin.layout>
    <div data-page="admin-inquiry-show" data-api-base="{{ url('/api/admin/inquiries') }}" class="p-4 sm:p-6 md:p-8">
        ...
        <div id="inquiryContent" class="hidden"></div>
        <div id="errorState" class="hidden py-20 text-center text-red-500 dark:text-red-400">
            <p id="errorMessage">Failed to load inquiry.</p>
