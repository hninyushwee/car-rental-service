import $ from 'jquery';
import { createCrudTable } from '../common/crud-table';
            ...
            return `
                <tr class="hover:bg-slate-50/50 dark:hover:bg-slate-700/20 transition-colors">
                    ...
                    <td class="py-3 px-4 text-right space-x-1">
                        <button type="button" data-action="edit" data-id="${id}" data-name="${name}" class="inline-flex items-center justify-center h-8 w-8 rounded-lg border border-slate-200 bg-white text-slate-500 hover:border-green-500 hover:bg-green-50 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-400 dark:hover:border-green-400 dark:hover:bg-green-950/30">
                            <i class="h-4 w-4 text-green-600 dark:text-green-400" data-lucide="edit"></i>
                        </button>
                        <button type="button" data-action="delete" data-id="${id}" class="inline-flex items-center justify-center h-8 w-8 rounded-lg border border-slate-200 bg-white text-red-500 hover:border-red-500 hover:bg-red-50 dark:border-slate-700 dark:bg-slate-900 dark:hover:border-red-400 dark:hover:bg-red-950/30">
